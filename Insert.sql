...
INSERT INTO `member` (`id`, `name`, `lastname`, `linkedin`, `email`, `short_desc`, `long_desc`, `status`, `photo_filename`, `ss`) VALUES
	...
	(18, 'Rodrigo Andrés', 'Burciaga Ornelas', 'https://www.linkedin.com/in/israel-a-vargas-monroy-18155a134/', 'isarael.vargas@deepdaemon.org', NULL, NULL, 'current', 'burciagaor.jpg', 1),
...
INSERT INTO `project` (`id`, `name`, `descr`, `impact`, `front_img`, `modal_media`, `modal_type`, `link`) VALUES
...
INSERT INTO `tech` (`id`, `name`, `descr`, `icon`) VALUES
	(1, 'NT', 'Nombre Tecnología', 'tech.png'),
	(2, 'ML', 'Machine learning', 'tech.png');
